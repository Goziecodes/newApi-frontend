...
export default function Register() {
  ...
  const AccountTypes = [
    ...
    { value: "checking", label: "Checking", key: "accountType"},
    { value: "health insurance scheme", label: "Health Insurance Scheme", key: "accountType"},
    { value: "retirement savings", label: "retirement Savings", key: "accountType"},
  ];
  const gender = [
